function lsrobj = computeOuputDataPreSetSequential(lsrobj)
global lsr
...
%     end
    lsrobj.dataout_preset.lsrVec = [lsrobj.dataout_preset.lsrVec; zeros(lsr.freq, 1)]; %0.1secs each
    if iLoc == 1
        vL = numel(lsrobj.dataout_preset.lsrVec);
    end
...
lsrobj.dataout_preset.maxDur = lsrobj.dataout_preset.vecLength / 400;